            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header text-center">
                        ...
                        <h3 class="mt-3"><?php echo $atleta["atleta"]["nombre"]." ".$atleta["atleta"]["apellido"] ?></h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="card-text"><strong>Cédula: </strong><?php echo $atleta["atleta"]["cedula"] ?></p>
                                <p class="card-text"><strong>Fecha de Nacimiento: </strong><?php echo $atleta["atleta"]["fecha_nacimiento"] ?></p>
                                <p class="card-text"><strong>Edad: </strong> 22 años</p>
                                <p class="card-text"><strong>Peso: </strong><?php echo $atleta["atleta"]["peso"] ?> kg</p>
                                <p class="card-text"><strong>Altura: </strong><?php echo $atleta["atleta"]["altura"] ?> cm</p>
                                <p class="card-text"><strong>Sexo: </strong><?php echo $atleta["atleta"]["genero"] ?></p>
