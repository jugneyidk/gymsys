                        ...
                        <div class="col-12 col-md-8 col-lg-9">
                                <div
                                        ...
                                        <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                                data-bs-target="#modalCrear" id="btnCrearRol">
                                                Crear Rol+
                                        </button>
                                </div>
                                ...
                                <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                <form method="post" id="form_incluir" autocomplete="off">
                                                        <input type="text" class="d-none" id="id_rol"
                                                                name="id_rol">
                                                        <div class="row">
                                                                <div class="col">
                                                                        ...
                                                                        <div id="snombre" class="invalid-feedback">
                                                                        </div>
                                                                </div>
                                                        </div>
                                                        <div class="row mb-2">
                                                        ...
                                                        <button type="button" id="btnSubmit"
                                                                class="btn btn-primary btn-block">Registrar
                                                                Rol</button>
                                                </form>
                                        </div>
                                </div>
