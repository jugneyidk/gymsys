                        ...
                        <div class="modal-body">
                            <form method="post" id="f1" autocomplete="off">
                                ...
                                <div class="row representante mb-3" style="display: none;">
                                    <div class="col-md-6">
                                        <label for="nombre_representante" class="form-label">Nombre del
                                            Representante:</label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="cedula_representante" class="form-label">Cédula del
                                            Representante:</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="parentesco_representante"
                            ...
                            <form method="post" id="f2" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="peso_modificar"
                                            name="peso_modificar" step="0.01">
                                        <div id="speso_modificar" class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="altura_modificar" class="form-label">Altura (cm):</label>
                                        <input type="number" class="form-control" id="altura_modificar"
                                            name="altura_modificar" step="0.01">
