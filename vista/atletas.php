        ...
        <div class="row justify-content-center w-100">
            <div class="col-12 col-md-8 col-lg-9">
                <div class="p-4 shadow">
                    <h2 class="text-center mb-4">Gestion de Atletas</h2>
                    <div class="row justify-content-center w-100 mb-3">
    <div class="col-12 text-center">
        <button type="button" class="btn btn-secondary mb-3 mx-2" onclick="resetForm()">Limpiar</button>
        <button type="button" class="btn btn-info mb-3 mx-2" data-bs-toggle="modal" data-bs-target="#modalInscripcion">Registrar Atleta</button>
    </div>
</div>
