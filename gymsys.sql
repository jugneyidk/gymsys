...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2024 a las 15:55:43
...
--
ALTER TABLE `bitacora`
  MODIFY `id_accion` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=692;
...
--
ALTER TABLE `mensualidades`
  MODIFY `id_mensualidad` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166;
