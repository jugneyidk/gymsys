            ...
            <table class="table table-hover">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="crolespermisos"
                           id="crolespermisos" value="1">
                     </td>
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="rrolespermisos"
                           id="rrolespermisos" value="1">
                     </td>
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="urolespermisos"
                           id="urolespermisos" value="1">
                     </td>
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="drolespermisos"
                           id="drolespermisos" value="1">
                     </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="creportes" id="creportes"
                           value="1">
                     </td>
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="rreportes" id="rreportes"
                           value="1">
                     </td>
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="ureportes" id="ureportes"
                           value="1" disabled>
                     </td>
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="dreportes" id="dreportes"
                           value="1" disabled>
                     </td>
                  </tr>
                  <tr>
                     ...
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="cbitacora" id="cbitacora"
                           value="1" disabled>
                     </td>
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="rbitacora" id="rbitacora"
                           value="1">
                     </td>
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="ubitacora" id="ubitacora"
                           value="1" disabled>
                     </td>
                     <td class="text-center">
                        <input class="form-check-input" type="checkbox" name="dbitacora" id="dbitacora"
                           value="1" disabled>
                     </td>
                  </tr>
               </tbody>
