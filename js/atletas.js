$(document).ready(function () {
  ...
  function validarEnvio(formId) {
      ...
      // Validaciones específicas para representante
      if (form.find("#edad").val() < 18) {
          esValido &= validarKeyUp(
              /^[a-zA-ZáéíóúÁÉÍÓÚ\s]{1,50}$/,
              form.find("#nombre_representante"),
              form.find("#snombre_representante"),
              "Solo letras y espacios (1-50 caracteres)"
          );
          esValido &= validarKeyUp(
              /^04\d{9}$/,
              form.find("#telefono_representante"),
              form.find("#stelefono_representante"),
              "El formato del teléfono debe ser 04XXXXXXXXX"
          );
      }
          ...
          success: function (respuesta) {
              try {
                  ...
                  if (lee.ok) {
                      ...
                      $("#f2 #entrenador_asignado_modificar").val(atleta.id_entrenador);
