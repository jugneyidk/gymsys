      ...
      success: function (respuesta) {
        try {
          ...
          if (lee.ok) {
            ...
            $("#f2 #fecha_nacimiento_modificar").val(
              entrenador.fecha_nacimiento
            );
            $("#f2 #lugar_nacimiento_modificar").val(
              entrenador.lugar_nacimiento
            );
            ...
            $("#f2 #grado_instruccion_modificar").val(
              entrenador.grado_instruccion
            );
