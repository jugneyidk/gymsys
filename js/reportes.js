            ...
            success: function (respuesta) {
                try {
                    ...
                    if (lee.ok && Array.isArray(lee.reportes)) {
                        ...
                        Swal.fire("Error", "No se encontraron reportes o la estructura de la respuesta es incorrecta.", "error");
                    }
                } catch (error) {
                    console.error("Error al procesar la respuesta JSON: ", error);
                    Swal.fire("Error", "Algo salió mal al procesar la respuesta del servidor", "error");
                }
            },
